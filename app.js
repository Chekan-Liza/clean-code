...
var taskInput=document.getElementsByClassName("input-new-task")[0];//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementsByClassName("list-incomplete")[0];//ul of .list-incomplete
var completedTasksHolder=document.getElementsByClassName("list-completed")[0];//completed-tasks
...
var taskCompleted=function(){
    ...
    //Append the task list item to the .list-completed
    var listItem=this.parentNode;
...
var taskIncomplete=function(){
    ...
    //Append the task list item to the .list-incomplete
    var listItem=this.parentNode;
